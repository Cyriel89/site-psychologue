export const aboutContent = {
    ...
    description: {
        presentation: "Je suis Pauline Dine, psychologue du travail basée à Nantes. Mon approche est centrée sur l'écoute, la bienveillance et l’accompagnement au rythme de chacun.",
